module TestLevels
    ...
    for rep in 1:3
        ...
        @test pool[4] === OrdinalValue(4, pool)
        @test pool.valindex == [OrdinalValue(i, pool) for i in pool.index]
    end
    ...
    for rep in 1:3
        ...
        @test pool[5] === OrdinalValue(5, pool)
        @test pool.valindex == [OrdinalValue(i, pool) for i in 1:5]
    end
    ...
    for rep in 1:3
        ...
        @test pool[6] === OrdinalValue(6, pool)
        @test pool[7] === OrdinalValue(7, pool)
        @test pool.valindex == [OrdinalValue(i, pool) for i in 1:7]
    end
    ...
    for rep in 1:3
        ...
        @test pool.invindex[12] === get(pool, 12)
        @test pool[8] === OrdinalValue(8, pool)
        @test pool[9] === OrdinalValue(9, pool)
        @test pool.valindex == [OrdinalValue(i, pool) for i in 1:9]
    end
    ...
    for rep in 1:3
        ...
        # TODO: Test invindex
        @test pool.valindex == [OrdinalValue(i, pool) for i in 1:8]
    end
    ...
    for rep in 1:3
        ...
        # TODO: Test invindex
        @test pool.valindex == [OrdinalValue(i, pool) for i in 1:6]
    end
