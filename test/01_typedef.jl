module TestTypeDef
    ...
    for i in 1:3
        ...
        @test_throws MethodError OrdinalValue(convert(CategoricalData.RefType, i), opool)
    ...
    for i in 1:3
        ...
        @test_throws MethodError NominalValue(convert(CategoricalData.RefType, i), opool)
